...
class Driver:  # klasa kierowcy danego pojazdu; posiada imię i wypłatę
...
drivers = [Driver(f"Driver {i + 1}", salary=3000 + i * 100) for i in range(20)]
vehicles = []
